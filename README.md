...
An incremental/idle game where you build a galactic empire starting from the Pre-Warp Age!
...
Galaxy Builder is a browser-based incremental game where you:
- **Start small** in the Pre-Warp Age with basic resources
...
- **Solar Panel**: Generates energy from stars
...
- **Scout Ship**: Light reconnaissance
- **Fighter**: Agile combat craft
- **Corvette**: Multi-role vessel
- **Destroyer**: Heavy weapons platform
...
- `suggestions.md` - Future development ideas
...
Contributions are welcome! Check the [suggestions.md](suggestions.md) file for ideas, or propose your own features.
